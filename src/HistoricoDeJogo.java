...
public class HistoricoDeJogo {
	...
	/**
	 * Informa o tipo de vitoria da partida. Podendo ser normal, de carroça, lá e ló e cruzada.
	 * 
	 * @param tipo O tipo de vitória.
	 */
	public void setTipoPontuacao(String tipo) {
		this.tipoPontuacao = tipo;
	}
